 ...
 * Fuente: INE Guatemala — 22 departamentos.
 */
export const MUNICIPIOS_POR_DEPARTAMENTO: Record<string, string[]> = {
  'Alta Verapaz': [
    'Cahabón', 'Chahal', 'Chisec', 'Cobán', 'Fray Bartolomé de las Casas',
    ...
    'Senahú', 'Tactíc', 'Tamahú', 'Tucurú',
  ],
  'Baja Verapaz': [
    'Cubulco', 'Granados', 'Purulhá', 'Rabinal', 'Salamá',
    'San Jerónimo', 'San Miguel Chicaj', 'Santa Cruz El Chol',
  ],
  'Chimaltenango': [
    'Acatenango', 'Chimaltenango', 'Comalapa', 'El Tejar', 'Parramos',
    'Patzicía', 'Patzún', 'Pochuta', 'San Andrés Itzapa', 'San José Poaquil',
    'San Martín Jilotepeque', 'Santa Apolonia', 'Santa Cruz Balanyá',
    'Tecpán Guatemala', 'Yepocapa', 'Zaragoza',
  ],
  'Chiquimula': [
  ...
  'Guatemala': [
    ...
    'San Juan Sacatepéquez', 'San Pedro Ayampuc', 'San Pedro Sacatepéquez',
    'San Raymundo', 'Santa Catarina Pinula', 'Villa Canales', 'Villa Nueva',
  ],
  'Huehuetenango': [
    'Aguacatán', 'Chiantla', 'Colotenango', 'Concepción Huista', 'Cuilco',
    'Huehuetenango', 'Ixtahuacán', 'Jacaltenango', 'La Democracia', 'La Libertad',
    'Malacatancito', 'Nentón', 'Petatán', 'San Antonio Huista', 'San Gaspar Ixchil',
    'San Juan Atitán', 'San Juan Ixcoy', 'San Marcos Huista', 'San Mateo Ixtatán',
  ...
  'Jutiapa': [
    ...
    'El Adelanto', 'El Progreso', 'Jalpatagua', 'Jerez', 'Jutiapa',
  ...
  'Petén': [
    ...
    'Melchor de Mencos', 'Poptún', 'San Andrés', 'San Benito', 'San Francisco',
  ...
  'Quetzaltenango': [
    ...
    'Ostuncalco', 'Palestina de Los Altos', 'Quetzaltenango', 'Salcajá',
    'San Carlos Sija', 'San Francisco La Unión', 'San Martín Sacatepéquez',
    'San Mateo', 'San Miguel Sigüilá', 'Sibilia', 'Zunil',
  ],
  'Quiché': [
    'Canillá', 'Chajul', 'Chicamán', 'Chiché', 'Chichicastenango', 'Chinique',
    'Cunén', 'Ixcán', 'Joyabaj', 'Nebaj', 'Pachalum', 'Patzité', 'Sacapulas',
    'San Andrés Sajcabajá', 'San Antonio Ilotenango', 'San Bartolomé Jocotenango',
    'San Juan Cotzal', 'San Pedro Jocopilas', 'Santa Cruz del Quiché',
    'Uspantán', 'Zacualpa',
  ],
  'Retalhuleu': [
  ...
  'San Marcos': [
    ...
    'El Rodeo', 'El Tumbador', 'Esquipulas Palo Gordo', 'Ixchiguán', 'La Blanca',
    'La Reforma', 'Malacatán', 'Nuevo Progreso', 'Ocós', 'Pajapita',
    'Río Blanco', 'San Antonio Sacatepéquez', 'San Cristóbal Cucho',
    'San José Ojetenam', 'San Lorenzo', 'San Marcos', 'San Miguel Ixtahuacán',
  ...
  'Sololá': [
    ...
    'Santa María Visitación', 'Santiago Atitlán', 'Sololá',
  ],
  'Suchitepéquez': [
    ...
    'San Juan Bautista', 'San Lorenzo', 'San Miguel Panán', 'San Pablo Jocopilas',
    'Santa Bárbara', 'Santo Domingo Suchitepéquez', 'Santo Tomás La Unión',
    'Zunilito',
  ],
  'Totonicapán': [
    'Momostenango', 'San Andrés Xecul', 'San Bartolo', 'San Cristóbal Totonicapán',
    'San Francisco El Alto', 'Santa Lucía La Reforma', 'Santa María Chiquimula',
    'Totonicapán',
  ],
  'Zacapa': [
    'Cabañas', 'Estanzuela', 'Gualán', 'Huité', 'La Unión',
    'Río Hondo', 'San Diego', 'Teculután', 'Usumatlán', 'Zacapa',
  ],
}